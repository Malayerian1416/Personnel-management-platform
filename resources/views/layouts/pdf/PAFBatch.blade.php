...
<table>
    ...
    <tr>
        ...
        <td style="vertical-align: top;width: 35%">
            ...
            @if(array_key_exists("marital_allowance",$employee->active_salary_details()))
                <div>حق تاهل</div>
            @endif
...
{{--            @endif--}}
        ...
        <td style="vertical-align: top;text-align: center;width: 15%;">
            ...
            @if(array_key_exists("marital_allowance",$employee->active_salary_details()))
                <div>{{number_format($employee->active_salary_details()["marital_allowance"])." ریال"}}</div>
            @endif
...
{{--                @endforeach--}}
{{--            @endif--}}
            <div>{{number_format(array_sum(array_column($employee->active_salary_details()["advantages"],"value")))." ریال"}}</div>
    ...
    <tr>
        <td colspan="4">
            <p>
                27 - وظیفه کارگر در این قرارداد عبارتست از انجام امور مربوط به وظایف شغل مندرج در بند 9 این قرارداد که بر اساس شرح وظایف مصوب شغل مندرج در طرح هماهنگ طبقه بندی مشاغل بوده این وظایف را در واحد محل خدمت تعیین شده طبق نظر کارفرما، تحت نظارت مافوق انجام دهد . نوبت کاری طبق ضوابط پرداخت می گردد . مزد و مزایای مندرج در این قرارداد بر مبنای مصوبات قانونی سال 1403 تنظیم شده است و از تاریخ عقد قرارداد مصوبات قانونی مزد و مزایای بر روی آنها لحاظ خواهد شد.
            </p>
        </td>
    </tr>
    <tr>
...
<table style="width: 100%;">
    <tr>
        ...
        <td style="height: {{count($employee->active_salary_details()["advantages"]) == 0 ? "200px" : (strval(200-(count($employee->active_salary_details()["advantages"]) * 5))) ."px"}};text-align: center;vertical-align: top;width: 40%">
