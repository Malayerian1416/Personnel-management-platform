    ...
    <div class="page">
        <div class="w-100 content-window bg-white rounded border">
            <div class="w-100 iransans p-3 border-bottom d-flex flex-row align-items-center justify-content-between">
                <div>
                    <i class="fa fa-building fa-1-4x ms-1"></i>
            ...
            <form id="main_submit_form" class="p-3"
                  action="{{ route("CompanyInformation.update",$company_information->id) }}" method="POST"
                ...
                <div class="form-row">
                    <div class="form-group mb-3 col-12">
                        ...
                        <input class="form-control text-center iranyekan @error('name') is-invalid @enderror"
                               type="text" name="name" value="{{ $company_information->name }}">
                        @error('name')
                    ...
                    <div class="form-group mb-3 col-12">
                        ...
                        <input class="form-control text-center iranyekan @error('website') is-invalid @enderror"
                               type="text" name="website" value="{{ $company_information->website }}">
                        @error('website')
                        <span class="invalid-feedback iransans small_font" role="alert">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group mb-3 col-12">
                        ...
                        <input class="form-control text-center iranyekan @error('address') is-invalid @enderror"
                               type="text" name="address" value="{{ $company_information->address }}">
                        @error('address')
                        <span class="invalid-feedback iransans small_font" role="alert">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-group mb-3 col-12">
                        ...
                        <input class="form-control text-center iranyekan @error('phone') is-invalid @enderror"
                               type="text" name="phone" value="{{ $company_information->phone }}">
                        @error('phone')
                        <span class="invalid-feedback iransans small_font" role="alert">{{ $message }}</span>
                        @enderror
                    </div>
