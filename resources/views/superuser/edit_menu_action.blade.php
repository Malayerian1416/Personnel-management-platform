...
@section('content')
    <div class="page-content w-100">
        <form id="main_submit_form" class="p-3" action="{{ route("MenuActions.update",$menu_action->id) }}"
            ...
            <div class="form-row">
                <div class="form-group mb-3 col-12">
                    ...
                    <input class="form-control text-center iransans @error('name') is-invalid @enderror" type="text"
                           name="name" value="{{ $menu_action->name }}">
                    @error('name')
                ...
                <div class="form-group mb-3 col-12">
                    ...
                    <input class="form-control text-center iransans @error('action') is-invalid @enderror" type="text"
                           name="action" value="{{ $menu_action->action }}">
                    @error('action')
                    <span class="invalid-feedback iransans small_font" role="alert">{{ $message }}</span>
                    @enderror
                </div>
                <div class="form-group mb-3 col-12 form-button-row text-center pt-4 pb-2">
                    ...
                    <a role="button" href="{{ route("MenuActions.index") }}" class="btn btn-outline-secondary iransans">
