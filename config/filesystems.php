...
return [
    ...
    */
    ...
    'disks' => [
        ...
        'employee_docs' => [
            'driver' => 'local',
            'root' => storage_path('app/private/employee_docs'),
            'url' => env('APP_URL').'/storage',
            'visibility' => 'private',
            'throw' => false,
        ],
        'form_templates' => [
            'driver' => 'local',
            'root' => storage_path('app/private/form_templates'),
            'url' => env('APP_URL').'/storage',
            'visibility' => 'private',
            'throw' => false,
        ],
        'temporarily' => [
            'driver' => 'local',
            'root' => storage_path('app/public/temporarily'),
            'url' => env('APP_URL').'/storage',
            'visibility' => 'public',
            'throw' => false,
        ],
        ...
        'occasions' => [
            'driver' => 'local',
            'root' => storage_path('app/public/occasions'),
            'url' => env('APP_URL').'/storage',
            'visibility' => 'public',
            'throw' => false,
        ],
