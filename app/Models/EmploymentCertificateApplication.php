...
class EmploymentCertificateApplication extends Model
{
    use softDeletes;
    protected $table = "employment_certificate_applications";
    protected $fillable = ["user_id","employee_id","recipient","is_accepted","is_refused","inactive","i_number","data"];
